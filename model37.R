...
regressors = c("ma_pct", "med_sal_", "appt_pct", "expert_pct", "advs_pct")
# names(fed)
...
lambdas = matrix(c(1,"lam21", 0, 0, 0, 0, 0, 1, "lam42", "lam52"), nrow = 5, ncol = 2)

meanifestmeans = matrix(c(0, "manifestmean2", 
                          0, "manifestmean4",
                          "manifestmean5"), nrow = length(regressors))
