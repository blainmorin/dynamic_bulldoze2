...
regressors = c("appt_pct", "expert_pct", "advs_pct", "ma_pct", "med_sal_")
# names(fed)
...
lambdas = matrix(c(1,"lam21", "lam31", 0, 0, 0, 0, 0, 1, "lam52"), nrow = 5, ncol = 2)

manifestmeans = matrix(c(0, "manifest2", "manifest3", 0, "manifest5"),
...
model = ctModel(type='stanct', 
                ...
                latentNames=c('Autonomy', 'Extertese'),
