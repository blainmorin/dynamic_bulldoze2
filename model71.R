...
regressors = c("doc_pct", "appt_pct",  "advs_pct", "ma_pct", "med_sal_", "LOSavg", "n_index")
# names(fed)
...
lambdas = c(1, "lam21", "lam31", 0, 0, 0, 0,
            0, 0, 0, 1, "lam52", "lam62", "lam72")
...
model = ctModel(type='stanct', 
                ...
                latentNames=c('Autonomy', 'Expertise'),
