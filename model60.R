...
regressors = c("appt_pct", "advs_pct", "b18_dng_r", "doc_pct")
# names(fed)
...
dff = df %>%
  ...
  mutate_at(c("appt_and_advs", "b18_dng_r", "doc_pct"), scale) %>%
  drop_na() 

regressors = c("appt_and_advs", "b18_dng_r", "doc_pct")
